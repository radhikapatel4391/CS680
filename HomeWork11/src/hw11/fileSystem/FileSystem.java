...
public class FileSystem {
	...
	public FSElement getElementFromfullPath(String s) {
		...
		if (s.contains("/") || s.contains("\\")) {
			// System.out.println("String before trim"+s);
			s = s.trim();
			...
			if (path[0].contains(this.root.getName())) {
				// System.out.println("Here with path o vale :"+path[0]);
				f = root;
				c = root;
			} else if (path[0].contains("..")) {
				// System.out.println("hello i am the
				// hell..."+this.getCurrentDirectory().getName());
			...
			if (l > 1 && c != null) { // System.out.println("...hghggyh..."+this.getCurrentDirectory().getName());
